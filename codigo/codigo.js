...
!(function (e, t) {
    ...
    var o = (function () {
                ...
                r(e, [
                    {
                        ...
                        value: function (e, t, s) {
                            var n = l.get("only", s);
                            !p || ("desktop" !== n && "mobile" === n)
                                ? !y || ("mobile" !== n && "desktop" === n)
                                    ? (this.adapter = new u(e, t).bindUnsupportedEvent())
                                    : (this.adapter = new c(e, t, s).bindEvents())
                                : (this.adapter = new h(e, t, s).bindEvents());
                        },
                    },
                    {
                        key: "preventSelect",
                        value: function (e, t) {
                            l.get("preventSelect", t) &&
        ...
        u = (function () {
            function e(t, s, i) {
                n(this, e), (this.el = t), (this.block = s), (this.options = i), (this.pressed = !1), (this.deepPressed = !1), (this.nativeSupport = !1), (this.runKey = Math.random());
            }
            return (
                r(e, [
                    {
                    ...
                    },
                    {
                        key: "fail",
                        value: function (e, t) {
                            l.get("polyfill", this.options) ? this.runKey === t && this.runPolyfill(e) : this.runClosure("unsupported", e);
                        },
                    },
                    {
                        ...
                        value: function () {
                            var e = this;
                            this.add(y ? "touchstart" : "mousedown", function (t) {
                    ...
                    },
                    {
                        key: "_startPress",
                        value: function (e) {
                            this.isPressed() === !1 && (this.setPressed(!0), this.runClosure("start", e));
                        },
                    },
                    {
                        key: "_startDeepPress",
                    ...
                    },
                    {
                        key: "_endPress",
                        value: function () {
                            this.isPressed() && (this._endDeepPress(), this.setPressed(!1), this.runClosure("end")), (this.runKey = Math.random()), (this.nativeSupport = !1);
                        },
                    },
                    {
                        key: "runPolyfill",
                        value: function (e) {
                            (this.increment = 10 / l.get("polyfillSpeed", this.options)), this.setPressed(!0), this.runClosure("start", e), this.loopPolyfillForce(0, e);
                        },
                    },
                    {
                        ...
                        value: function (e, t) {
                            this.isPressed() &&
                                ...
                                (this.runClosure("change", e, t), e >= 0.5 ? this._startDeepPress(t) : this._endDeepPress(), (e = e + this.increment > 1 ? 1 : e + this.increment), setTimeout(this.loopPolyfillForce.bind(this, e, t), 10));
                        },
                    },
                ]),
                e
                ...
                r(i, [
                    {
                        ...
                        value: function () {
                            b
                                ? (this.add("touchforcechange", this.start.bind(this)), this.add("touchstart", this.supportTest.bind(this, 0)), this.add("touchend", this._endPress.bind(this)))
                                : (this.add("touchstart", this.startLegacyTest.bind(this)), this.add("touchend", this._endPress.bind(this)));
                        },
                    },
                    {
                        key: "start",
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            this.isPressed() === !1 && (e <= 6 ? (e++, setTimeout(this.supportTest.bind(this, e, t, s), 10)) : this.fail(t, s));
                        },
                    },
                    {
                        key: "startLegacyTest",
                        value: function (e) {
                            (this.initialForce = e.touches[0].force), this.supportLegacyTest(0, e, this.runKey, this.initialForce);
                        },
                    },
                    {
                        key: "supportLegacyTest",
                        value: function (e, t, s, n) {
                            n !== this.initialForce ? (this._startPress(t), this.loopForce(t)) : e <= 6 ? (e++, setTimeout(this.supportLegacyTest.bind(this, e, t, s, n), 10)) : this.fail(t, s);
                        },
                    },
                    {
                        key: "loopForce",
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            for (var t = 0; t < e.touches.length; t++) if (e.touches[t].target === this.el) return this.returnTouch(e.touches[t], e);
                        },
                    },
                    {
                        key: "returnTouch",
                        value: function (e, t) {
                            return e.force >= 0.5 ? this._startDeepPress(t) : this._endDeepPress(), e;
                        },
                    },
                ]),
                i
        ...
        a = function (e, t) {
            ...
            if ("string" == typeof e || e instanceof String) for (var n = document.querySelectorAll(e), i = 0; i < n.length; i++) new o(n[i], t, s);
            else if (d(e)) new o(e, t, s);
            else for (var i = 0; i < e.length; i++) new o(e[i], t, s);
        },
        d = function (e) {
            return "object" === ("undefined" == typeof HTMLElement ? "undefined" : i(HTMLElement))
                ? e instanceof HTMLElement
                : e && "object" === ("undefined" == typeof e ? "undefined" : i(e)) && null !== e && 1 === e.nodeType && "string" == typeof e.nodeName;
        },
        ...
        y = !1,
        b = !1;
    "undefined" != typeof window && ((y = "ontouchstart" in window.document), (p = !y), (b = "ontouchforcechange" in window.document));
});
...
function coveranimation() {
    ...
    elem0.velocity({ left: "1100px" }, { duration: 11000, easing: "linear" }).delay(1).velocity({ left: "0px" }, { duration: 1 });
    elem1.velocity({ left: "2200px" }, { duration: 11000, easing: "linear" }).delay(1).velocity({ left: "1100px" }, { duration: 1 });
    elem2.velocity({ left: "0px" }, { duration: 11000, easing: "linear" }).delay(1).velocity({ left: "-1100px" }, { duration: 1 });
